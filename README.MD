...
- ~~Извлеките и скопируйте openNISDk_ROS2_xxx.tar.gz в ~/ros2_ws/src/~~
...
colcon build --event-handlers console_direct+ --cmake-args -DCMAKE_BUILD_TYPE=Release```Запуск камеры
```
